...
document.querySelector("#greet").innerHTML = Object(_hello_world_hello_world__WEBPACK_IMPORTED_MODULE_5__["greet"])();
document.querySelector("#os").innerHTML = osMap[process.platform];
document.querySelector("#author").innerHTML = manifest.author;
document.querySelector("#env").innerHTML = env__WEBPACK_IMPORTED_MODULE_6__.name;
